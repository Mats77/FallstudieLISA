...
public class Handler {
	...
	public void sendReady(){	//�bermittelt dem server, dass der Spieler rdy ist und button in der Lobby gedr�ckt hat
		conn.send("READY ");
	}
	
	public void handleString(String txt){
		if(txt.startsWith("CONNECTED")){	//ver�ndert das GUI
			gui.connected();
