...
public class Handler {
	...
	private int gameID; // Um Eindeutigkeit des Spiels zu gewÃ¤hrleisten (Wird in alle Conn-Klassen Ã¼bertragen)
	...
	public void sendPlayerOrderPool(int playerID, PlayerOrderPool playerOderPool) {
		...
		// an den obigen String anhÃ¤ngen: newOrders:OrderID,Kundennamen,Bestellmenge,Lieferzeitpunkt;
		if (newOrders.size() > 0) {
			txt += " newOrders:";
	...
	public void offerCredit(double[] offer, String nick) {	//FÃ¼r den Spieler mit dem nick muss das Angebot zurÃ¼ckgegeben werden
